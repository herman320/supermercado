                ...
                <div class="row is-table-row">
                    ...
                    <div class="col-sm-4" ng-repeat="product in pCtrl.mvProducts">                    	
                        <div class="thumbnail">
                            ...
                            <hr/>
                            <div class="caption">
                                <h4 class="pull-right">Q. {{product.unitPrice}}</h4>
                                <p>{{product.description}}</p>
                                <a ng-href="${contextRoot}/show/{{product.id}}/product" class="btn btn-primary pull-right">Mostrar</a>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-4 col-lg-4 col-md-4">
                        <h4>Ver mas productos!</h4>
                        <hr/>
                        <a class="btn btn-primary" href="${contextRoot}/show/all/products">Mas productos</a>
                    </div>
