    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="${contextRoot}/home">Tienda en linea</a>
            </div>
            <!-- Collect the nav links, forms, and other content for toggling -->
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <li id="about">
                        <a href="${contextRoot}/about">Acerca de nosotros</a>
                    </li>

                    <li id="contact">
                        <a href="${contextRoot}/contact">Contactar</a>
                    </li>
                    
                    <li id="listProducts">
                        <a href="${contextRoot}/show/all/products">Ver productos</a>
                    </li>
					<security:authorize access="hasAuthority('ADMIN')">
	                    <li id="manageProduct">
	                        <a href="${contextRoot}/manage/product">Administrar productos</a>
	                    </li>					
					</security:authorize>
                </ul>
			    ...
			    <ul class="nav navbar-nav navbar-right">
			    	<security:authorize access="isAnonymous()">
						...
						<li id="login">
	                        <a href="${contextRoot}/login">Ingresar</a>
	                    </li> 			    	
			    	</security:authorize>
			    	<security:authorize access="isAuthenticated()">
						<li class="dropdown" id="userModel">
						  ...
						  <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
							...
							<li id="logout">
		                        <a href="${contextRoot}/logout">Salir</a>
		                    </li>                    			    	
						  </ul>		
						</li>    			    
			    	</security:authorize>                    
